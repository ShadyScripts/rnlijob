 ...
 RegisterNetEvent('hospital:server:ambulanceAlert', function(text)
    ...
    local coords = GetEntityCoords(ped)
     ...
     for k,v in pairs(players) do
         if v.PlayerData.job.name == 'rnlijob' and v.PlayerData.job.onduty then
...
Citizen.CreateThread(function()
    local resourceName = "shady-RNLIjob Started } Discord : https://discord.gg/8JdxQNRXVj made by Slim Shady ("..GetCurrentResourceName()..")"
    print("\n^4----------------------------------------------------------------------------------^7")
    print(resourceName)
    print("^4----------------------------------------------------------------------------------^7")
end)
